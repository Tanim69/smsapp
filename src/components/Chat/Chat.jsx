            ...
            <div className='flex items-center justify-between  border-b-2 pb-[14px]  '>
                <div className='flex items-center'>
                    ...
                    <div>
                        ...
                        <p className='font-pops text-[18px] font-semibold'>{active.name}</p>
        ...
        <p className='text-[14px] font-medium text-[#4D4D4DBF]'>Today,02:02pm</p>
            ...
            <div className=' flex gap-x-[20px] border-t-2 border-red-500  '>
                ...
                <div className='flex w-full mt-[10px] '>
                    <input onChange={(e) => setMsg(e.target.value)} type="text" className='bg-red-300 h-[45px] w-full rounded  flex justify-end outline-none p-5' />
                    ...
                    <button onClick={()=>handleSendMsg(msg)} className='bg-primary ml-[20px] px-[30px] rounded-lg'>Send</button>
